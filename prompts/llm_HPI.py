...
def build_hpi(case_text):
    prompt = f"""Format a clinical case for to present to another attending physician viewing the case. Below is raw case information collected field-by-field from a clinician.
